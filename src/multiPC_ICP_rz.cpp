	  ...
	  pcl::PassThrough<PointType> pass;
 	  ...
 	  pass.filter (*cloud_filtered);
	     ...
	     trot<<1, 0, 0, 0,
				 ...
				 0, 0, 0, 1;
	     Eigen::Matrix3f m;
	     m=Eigen::AngleAxisf(0,Eigen::Vector3f::UnitZ());
	     //std::cout<<m<<std::endl;
	   ...
	   //  myfile.open ("/home/idf/ros/catkin_ws/datos.txt");
		 ...
		 //ICP
	     for(int i=0;i<360;i++){
	    	 angle_z=(i+1.0)*(M_PI/180.0);
		     m=Eigen::AngleAxisf(angle_z,Eigen::Vector3f::UnitZ());
		     trot.block<3,3>(0,0)=m;
	   		  pcl::transformPointCloud (*model, *initial_model, trot);
		...
		//  myfile<<angle_z<<" "<<icp.nr_iterations_<<" "<<elapsed.count()<<" "<<icp.getFitnessScore()<<"\n";
